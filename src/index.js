...
const carerDocumentRoutes = require("./routes/administration/staffdoc");
...
const documentRouter = require("./routes/administration/staff-document");
// env config
...
app.use("/api/staffdocument",documentRouter);
